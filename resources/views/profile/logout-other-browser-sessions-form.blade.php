<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puede salir de todas sus otras sesiones del navegador en todos sus dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; Sin embargo, esta lista puede no ser exhaustiva. Si cree que su cuenta se ha comprometido, también debe actualizar su contraseña.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar todas las otras sesiones') }}
            </x-jet-button>
