...
@section('content_header')
    <div class="shadow p-3 mb-5 bg-white rounded"><h1>Crear un nuevo tipo de habitación</h1></div>
@stop
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Crear un nuevo tipo de habitación</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('tipo-habitacions.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
