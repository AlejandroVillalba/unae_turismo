...
@section('content_header')
    <div class="shadow p-3 mb-5 bg-white rounded"><h1>Tipo de habitacion</h1></div>
@stop
@section('content')
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                             <div class="float-right">
                                <a href="{{ route('tipo-habitacions.create') }}" class="btn btn-block bg-gradient-info btn-flat"  data-placement="left">
                                  {{ __('Crear nuevo') }}
                                </a>
                              </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($tipoHabitacions as $tipoHabitacion)
                                        <tr>
                                            ...
                                            <td>
                                                <form  action="{{ route('tipo-habitacions.destroy',$tipoHabitacion->id) }}" class="formulario-eliminar" method="POST">
