...
@section('content_header')
    <div class="shadow p-3 mb-5 bg-white rounded"><h1>Servicios de los alojamientos</h1></div>
@stop
                                ...
                                <tbody>
                                    @foreach ($servicios as $servicio)
                                        <tr>
                                            ...
                                            <td>
                                                <form  action="{{ route('servicios.destroy',$servicio->id) }}" class="formulario-eliminar" method="POST">
