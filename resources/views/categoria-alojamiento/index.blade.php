                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                             <div class="float-right">
                                <a href="{{ route('categoria-alojamientos.create') }}" class="btn btn-block bg-gradient-info btn-flat"  data-placement="left">
                                  {{ __('Crear nuevo') }}
                                </a>
                              </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="categoriaAlojamientos" class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
                                        <th>N°</th>
										<th>Nombre</th>
...
@section('js')
    ...
    $(document).ready( function () {
        $('#categoriaAlojamientos').DataTable({
            "language": {
                "search": "Buscar:",
